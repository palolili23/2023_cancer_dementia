...
- Observational studies have found an inverse association between cancer and the risk of Alzheimer´s disease or related dementias (ADRD).
...
$P_0$ = Pin1 over-expression; $Y_{t+1}$ = Dementia diagnosis
...
---
### Cancer diagnosis as the proxy of Pin1 biomarker (Problem 2: _Time zero_)
...
- Cancer as _"time-fixed ever vs. never"_ vs. cancer as a _time-varying proxy_ 
...
- Risk of dementia is estimated with a weighted Kaplan-Meier estimator.

---
### Peterson upper and lower bounds
...
In the cancer arm 6% had dementia and 63% died, in the free of cancer arm 14% had dementia and 23% died.

]

---
### Cancer as time-fixed ever vs. never proxy
...
### Cancer diagnosis as time-varying proxy
