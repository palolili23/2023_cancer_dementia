...
In a population of x, free of cancer and dementia at baseline...

We first do counts:

Time to cancer on average

We show 3 kinds, ever vs. never, time-varying cancer, and weighting by cancer dx.

We now show the risk if U, no U (Combined outcome, crude risk)

We provide additional info on causes of death for both groups, and the extreme scenarios of bounds.

## Discussion


Through this example we describe how much do the direct effect of cancer changes if we measure and adjust for $C$ compared to not.
